...
export const BentoGridItem = ({
  ...
  const rightLists = ["Drizzle", "Next JS", "Prisma"];
  ...
  const handleCopy = () => {
    const text = "work.devsethi@gmail.com";
  ...
  return (
    <div
      className={cn(
        ...
        "row-span-1 relative overflow-hidden rounded-3xl border border-white/[0.1] group/bento grid-box hover:shadow-xl transition duration-200 shadow-input dark:shadow-none justify-between flex flex-col space-y-4",
        className
      )}
      style={{
        //   add these two
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          {/* remove mb-2 mt-2 */}
          <div
            className={`text-lg text-white/85 lg:text-3xl max-w-96 font-bold z-10`}
          >
            {title}
          </div>

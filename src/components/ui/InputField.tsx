  ...
  return (
    <div className="relative">
      <input
        ...
        name={name}
        type={type}
        className={`border-b border-gray-300 w-full py-1 focus:border-b-2 focus:border-primary transition-colors focus:outline-none peer bg-inherit placeholder-transparent ${className}`}
